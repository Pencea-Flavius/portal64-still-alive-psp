#ifndef __GRAPHICS_N64_GRAPHICS_H__
#define __GRAPHICS_N64_GRAPHICS_H__

// The N64 half of the frame object; see src/graphics/psp/graphics.h.
// A frame is an RSP task: display list, framebuffer and done message.
