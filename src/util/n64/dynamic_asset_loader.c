...
// The N64 half of the dynamic asset loader (src/util/psp/...). A dynamic
// model lives in its own ROM segment: copy it into RAM, then shift every
// pointer in its display list by how far it moved.
